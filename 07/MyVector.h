...
template <class T>
typename const MyVector<T>::const_iterator MyVector<T>::cbegin() {
	return iterator(first_);
}

template <class T>
typename const MyVector<T>::const_iterator MyVector<T>::cend() {
	return iterator(last_);
}

template <class T>
typename const MyVector<T>::const_reverse_iterator MyVector<T>::crbegin() {
	return std::reverse_iterator<iterator>(cbegin());
}

template <class T>
typename const MyVector<T>::const_reverse_iterator  MyVector<T>::crend() {
